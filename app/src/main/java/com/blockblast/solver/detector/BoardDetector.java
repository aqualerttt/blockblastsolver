...
public static final float BOARD_TOP_PCT    = 0.238f; // Moved up from 0.245 to catch the true top edge
...
public static final float BOARD_BOTTOM_PCT = 0.648f; // Moved down from 0.635 to reach the true bottom edge
